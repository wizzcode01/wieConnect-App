    ...
    return (
        <div className="min-h-screen overflow-hidden w-full relative flex flex-col items-center justify-center  bg-gray-900">
            <div className="w-full lg:ml-0 text-center ">
                ...
                <p className="text-sm text-gray-400 font-bold ">Login With One of The Following</p>
            </div>    
        <div className="flex flex-col items-center w-[95%] max-w-md bg-gray-900 px-8 py-10 ">
          <div className="flex justify-center items-center gap-5">
            ...
            className="flex flex-col w-full mt-10 gap-2">
                ...
                <button
               className="bg-[#4a006f] font-bold text-white text-[1.2rem] px-4 py-2 mt-12 m-auto rounded-lg w-56 hover:bg-white hover:text-[#4a006f] hover:border-[#702794] transition-all ease-in-out duration-300 cursor-pointer"
               type="submit"
              >
                Login
            </button>
