    ...
    return (
        <div className="min-h-screen overflow-hidden w-full relative flex flex-col items-center justify-center  bg-gray-900">
            <div className="w-full lg:ml-0 text-center ">
                <h1 className="text-3xl font-bold bg-gradient-to-r from-purple-500 to-pink-600 bg-clip-text text-transparent mb-6">Login - wieConnect</h1>
        ...
        <div className="flex flex-col items-center w-full max-w-md bg-gray-900 px-8 py-10 ">
          <div className="flex justify-center items-center gap-5">
            <FaGoogle className=" bg-gray-900 cursor-pointer text-white border rounded-lg border-[#9003d6] text-4xl w-28 p-2"/>
            <FaApple className="text-white cursor-pointer border border-[#9003d6] rounded-lg bg-gray-900 text-4xl w-28 p-2"/>
          </div>  
            <form 
            className="flex flex-col w-full mt-10 gap-2">
                ...
                <button
               className="bg-[#9003d6] font-bold text-white text-[1.2rem] px-4 py-2 mt-5 m-auto rounded-4xl w-72 hover:bg-white hover:text-[#4a006f] hover:border-[#702794] transition-all ease-in-out duration-300 cursor-pointer"
               type="submit"
              >
                Login
            </button>
