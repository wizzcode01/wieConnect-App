...
const Registration = () => {
  ...
  const handleSecondSubmit = (e) => {
    ...
    if(step === 1) {
      return (
        <div className="min-h-screen w-full relative flex flex-col items-center justify-center gap-5 bg-gray-900">
          <div>
        ...
        <div className="flex flex-col items-center w-full max-w-md bg-gray-900 px-6 "> 
            ...
            className="flex flex-col w-full gap-2">
                ...
                <button
                  ...
                  className="bg-[#9003d6] font-bold text-gray-100 text-[1.5rem] px-4 py-2 mt-5 m-auto rounded-4xl w-72 hover:bg-white hover:text-[#4a006f] transition-all ease-in-out duration-300 cursor-pointer"
                  type="submit"
                >
        ...
        <div className="flex flex-col justify-center items-center gap-3 p-3">
           ...
           Already have an account?{" "} <Link to="/login" className="text-gray-100">Log In</Link></p> 
        </div>
    ...
    return (
         <div className="min-h-screen w-full relative flex flex-col items-center justify-center  bg-gray-900">
            <div className="w-full flex gap-5 justify-center items-center ">
                <h1 className="text-4xl font-bold bg-gradient-to-r from-purple-700 to-pink-600 bg-clip-text text-transparent">WieConnect</h1>
            </div>    
           <div className="flex flex-col items-center w-full max-w-md bg-gray-900 px-8 py-10 ">
            ...
            className="flex flex-col w-full gap-2">
                ...
                <button
                  ...
                  className="bg-[#9003d6] font-bold text-gray-100 text-[1.1rem] px-4 py-2 mt-5 m-auto rounded-4xl w-72 hover:bg-gray-100 hover:text-[#4a006f] transition-all ease-in-out duration-300 cursor-pointer"
                  type="submit"
                >
                Sign up
                </button>
